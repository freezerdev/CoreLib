...
public:
	...
	friend CStr8 operator+(const CStr8 &str1, const CStr8 &str2);
	friend CStr8 operator+(const CStr8 &str1, const CStrW &str2);
	friend CStr8 operator+(const CStrW &str1, const CStr8 &str2);
	friend CStr8 operator+(const CStrW &str1, const CStrW &str2);
	friend CStr8 operator+(const CStr8 &str1, PCSTR sz2);
	friend CStr8 operator+(const CStrW &str1, PCSTR sz2);
	friend CStr8 operator+(const CStr8 &str1, PCWSTR sz2);
	friend CStr8 operator+(const CStrW &str1, PCWSTR sz2);
	friend CStr8 operator+(const CStr8 &str1, const char ch2);
	friend CStr8 operator+(const CStrW &str1, const char ch2);
	friend CStr8 operator+(const CStr8 &str1, const wchar_t ch2);
	friend CStr8 operator+(const CStrW &str1, const wchar_t ch2);
	friend CStr8 operator+(PCSTR sz1, const CStr8 &str2);
	friend CStr8 operator+(PCSTR sz1, const CStrW &str2);
	friend CStr8 operator+(PCWSTR sz1, const CStr8 &str2);
	friend CStr8 operator+(PCWSTR sz1, const CStrW &str2);
	friend CStr8 operator+(const char ch1, const CStr8 &str2);
	friend CStr8 operator+(const char ch1, const CStrW &str2);
	friend CStr8 operator+(const wchar_t ch1, const CStr8 &str2);
	friend CStr8 operator+(const wchar_t ch1, const CStrW &str2);
#endif
