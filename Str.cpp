...
#else
//#################################################################################################
CStr8 CStr8::AsNative(void) const
{
	return *this;
}
#endif
...
#ifndef _WIN32
//#################################################################################################
CStr8 operator+(const CStr8 &str1, const CStr8 &str2)
{
	CStr8 strRtn(str1);
	strRtn.Append(str2);
	return strRtn;
...
//#################################################################################################
CStr8 operator+(const CStr8 &str1, const CStrW &str2)
{
	CStr8 strRtn(str1);
	strRtn.Append(str2);
	return strRtn;
...
//#################################################################################################
CStr8 operator+(const CStrW &str1, const CStr8 &str2)
{
	CStr8 strRtn(str1);
	strRtn.Append(str2);
	return strRtn;
...
//#################################################################################################
CStr8 operator+(const CStrW &str1, const CStrW &str2)
{
	CStr8 strRtn(str1);
	strRtn.Append(str2);
	return strRtn;
...
//#################################################################################################
CStr8 operator+(const CStr8 &str1, PCSTR sz2)
{
	CStr8 strRtn(str1);
	strRtn.Append(sz2);
	return strRtn;
...
//#################################################################################################
CStr8 operator+(const CStrW &str1, PCSTR sz2)
{
	CStr8 strRtn(str1);
	strRtn.Append(sz2);
	return strRtn;
...
//#################################################################################################
CStr8 operator+(const CStr8 &str1, PCWSTR sz2)
{
	CStr8 strRtn(str1);
	strRtn.Append(sz2);
	return strRtn;
...
//#################################################################################################
CStr8 operator+(const CStrW &str1, PCWSTR sz2)
{
	CStr8 strRtn(str1);
	strRtn.Append(sz2);
	return strRtn;
...
//#################################################################################################
CStr8 operator+(const CStr8 &str1, const char ch2)
{
	CStr8 strRtn(str1);
	strRtn.Append(ch2);
	return strRtn;
...
//#################################################################################################
CStr8 operator+(const CStrW &str1, const char ch2)
{
	CStr8 strRtn(str1);
	strRtn.Append(ch2);
	return strRtn;
...
//#################################################################################################
CStr8 operator+(const CStr8 &str1, const wchar_t ch2)
{
	CStr8 strRtn(str1);
	strRtn.Append(ch2);
	return strRtn;
...
//#################################################################################################
CStr8 operator+(const CStrW &str1, const wchar_t ch2)
{
	CStr8 strRtn(str1);
	strRtn.Append(ch2);
	return strRtn;
...
//#################################################################################################
CStr8 operator+(PCSTR sz1, const CStr8 &str2)
{
	CStr8 strRtn(sz1);
	strRtn.Append(str2);
	return strRtn;
...
//#################################################################################################
CStr8 operator+(PCSTR sz1, const CStrW &str2)
{
	CStr8 strRtn(sz1);
	strRtn.Append(str2);
	return strRtn;
...
//#################################################################################################
CStr8 operator+(PCWSTR sz1, const CStr8 &str2)
{
	CStr8 strRtn(sz1);
	strRtn.Append(str2);
	return strRtn;
...
//#################################################################################################
CStr8 operator+(PCWSTR sz1, const CStrW &str2)
{
	CStr8 strRtn(sz1);
	strRtn.Append(str2);
	return strRtn;
...
//#################################################################################################
CStr8 operator+(const char ch1, const CStr8 &str2)
{
	CStr8 strRtn(ch1);
	strRtn.Append(str2);
	return strRtn;
...
//#################################################################################################
CStr8 operator+(const char ch1, const CStrW &str2)
{
	CStr8 strRtn(ch1);
	strRtn.Append(str2);
	return strRtn;
...
//#################################################################################################
CStr8 operator+(const wchar_t ch1, const CStr8 &str2)
{
	CStr8 strRtn(ch1);
	strRtn.Append(str2);
	return strRtn;
...
//#################################################################################################
CStr8 operator+(const wchar_t ch1, const CStrW &str2)
{
	CStr8 strRtn(ch1);
	strRtn.Append(str2);
	return strRtn;
...
#else
void CStr8::DebugPrint(const bool bAppendNewline) const
#endif
{
	if(m_nStrLen)
	{
...
#else
//#################################################################################################
CStr8 CStrW::AsNative(void) const
{
	return CStr8(*this);
}
#endif
...
bool CStrW::LoadString(const UINT nId)
{
	...
	PWSTR sz = nullptr;
	int nResult = LoadStringW(GetApplicationInstance(), nId, (PWSTR)&sz, 0);
	if(nResult)
	{
		Assign(sz, 0, nResult);
		bResult = true;
...
{
#ifndef _WIN32
	// Be very careful when calling this function on Linux/MacOS. For example, the '%s' and '%S' specifiers have different meanings on Windows and Linux/MacOS.
//	Assert(false);
#endif
	bool bFormatted;
...
{
#ifndef _WIN32
	// Avoid this function on Linux/MacOS.  vswprintf() does not return required size unlike vsnprintf().
	// Therefore try a single load with 256 character buffer, but this might fail.
//	Assert(false);
#endif
	bool bFormatted = true;
...
#else
void CStrW::DebugPrint(const bool bAppendNewline) const
#endif
{
	if(m_nStrLen)
	{
...
#else
		size_t nBufLen = WideToUtf8(m_sz, m_nStrLen, nullptr, 0) + 1;
		auto szTemp = std::make_unique<char[]>(nBufLen);
		size_t nStrLen = WideToUtf8(m_sz, m_nStrLen, szTemp.get(), nBufLen);
		szTemp[nStrLen] = g_chNull8;
...
#else
//#################################################################################################
CStr8 CStr16::AsNative(void) const
{
	return CStr8(*this);
}
#endif
...
#else
void CStr16::DebugPrint(const bool bAppendNewline) const
#endif
{
	if(m_nStrLen)
	{
...
#else
		size_t nBufLen = Utf16ToUtf8(m_sz, m_nStrLen, nullptr, 0) + 1;
		auto szTemp = std::make_unique<char[]>(nBufLen);
		size_t nStrLen = Utf16ToUtf8(m_sz, m_nStrLen, szTemp.get(), nBufLen);
		szTemp[nStrLen] = g_chNull8;
