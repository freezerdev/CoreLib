...
ERRCODE ConvertFromNativeErrorCode(const ERRCODE nNativeErrorCode) noexcept
{
	...
	case EIO:
		nErrorCode = FW_ERROR_LOW_LEVEL;
		break;

	case EISDIR:
		nErrorCode = FW_ERROR_IS_DIR;
		break;

	case ELOOP:
	case EMLINK:
		nErrorCode = FW_ERROR_LINK;
		break;

	case EMFILE:
	case ENFILE:
		nErrorCode = FW_ERROR_HANDLES;
		break;
	...
	case ENOTDIR:
		nErrorCode = FW_ERROR_IS_NOT_DIR;
		break;

	case EOPNOTSUPP:
		nErrorCode = FW_ERROR_NOT_SUPPORTED;
		break;
