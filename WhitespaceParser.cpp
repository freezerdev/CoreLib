...
{	// Size in bytes
	return GetLength(bIncludeNullTerm) * sizeof(NCHAR);
}
...
//#################################################################################################
CWhitespaceParser &CWhitespaceParser::operator=(PCNSTR sz)
{
	Assign(sz);
	return *this;
}
...
//#################################################################################################
void CWhitespaceParser::Assign(PCNSTR sz)
{
	Empty();
	Append(CStr(sz));
}
...
//#################################################################################################
void CWhitespaceParser::Append(PCNSTR sz)
{
	Append(CStr(sz));
}
